...
#define	LCD_RST PBout(9)  //LCD背光    		 RESET
#define	LCD_CS  PBout(8)  //LCD背光    		 CS
#define	LCD_RS  PCout(15) //LCD背光    		 RS
#define	LCD_WR  PCout(14) //LCD背光    		 WR
#define	LCD_RD  PCout(13) //LCD背光    		 RD
...
//PC0~7,作为数据口
#define DATAOUT(x) GPIOB->ODR=((GPIOB->ODR & 0xff00) | (x));  // 怎加了15ms显示时间
